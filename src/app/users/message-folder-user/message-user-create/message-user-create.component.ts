...
@Component({
  selector: 'app-message-user-create',
  templateUrl: './message-user-create.component.html',
  styleUrls: ['./message-user-create.component.css']
})
export class MessageUserCreateComponent implements OnInit {
